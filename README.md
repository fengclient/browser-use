...
```text
Install or upgrade browser-use-volcengine to the latest stable version with uv using Python 3.12, run `browser-use-volcengine skill install` to register the skill, and connect it to my browser. If setup or connection fails, follow https://github.com/browser-use/browser-harness/blob/main/install.md.
```
...
**1. Install the Browser Use Volcengine fork (Python >= 3.11):**
